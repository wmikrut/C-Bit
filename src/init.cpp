 ...
 * between c-bitd, and c-bit-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/dido1010/c-bit>";
    const std::string URL_WEBSITE = "<http://www.xct-cbits.com/>";
